...
(function () {
  ...
  const I18N = {
    nl: {
      ...
      'plan.starter.f4': 'E-mail, Slack & Teams alerts',
      ...
      'plan.pro.f3': 'Geautomatiseerde playbooks',
      'plan.pro.f4': 'Threat intelligence & prioriteit-support',
    ...
    en: {
      ...
      'plan.starter.f4': 'Email, Slack & Teams alerts',
      'plan.med.name': 'Medium',
      'plan.med.price': '€999',
      ...
      'plan.pro.f3': 'Automated playbooks',
      'plan.pro.f4': 'Threat intelligence & priority support',
      'plan.ent.name': 'Enterprise',
